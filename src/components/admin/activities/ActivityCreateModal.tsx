          ...
          <div className="max-h-[72vh] overflow-y-auto px-6 py-5 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <Label htmlFor="create-docURL" className="text-xs font-semibold text-[#002660] flex items-center gap-1.5">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <Label htmlFor="create-allImageURL" className="text-xs font-semibold text-[#002660] flex items-center gap-1.5">
