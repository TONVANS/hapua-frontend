...
interface CountriesHeaderBarProps {
  search: string;
...
export function CountriesHeaderBar({
  search,
  setSearch,
  loading,
  onRefresh,
  onOpenCreate,
}: CountriesHeaderBarProps) {
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-[#002660] tracking-tight">Countries Master Data</h2>
          <p className="text-xs text-[#4f616f]">ASEAN member states and international dialogue partners</p>
        </div>
