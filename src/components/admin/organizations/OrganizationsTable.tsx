    ...
    <div className="bg-white rounded-2xl border border-[#e2e8f0] overflow-hidden shadow-xs">
      <Table>
        <TableHeader className="bg-[#f7f9fb] border-b border-[#e2e8f0]">
          <TableRow>
            <TableHead className="text-xs font-bold text-[#002660]">Full Organization Name</TableHead>
            <TableHead className="text-xs font-bold text-[#002660]">Acronym</TableHead>
        ...
        <TableBody>
          {loading ? (
            ...
            <TableRow>
              <TableCell colSpan={3} className="h-32 text-center text-xs text-[#747781]">
                <Building2 className="w-8 h-8 mx-auto text-[#c4c6d2] mb-2" />
            ...
            organizations.map((org) => (
              ...
              >
                ...
                <TableCell className="py-3 text-xs">
                  {org.shortName ? (
                    <span className="px-2.5 py-0.5 rounded-full bg-[#f2f4f6] text-[#002660] font-bold truncate max-w-[120px] inline-block" title={org.shortName}>
                      {org.shortName}
                    </span>
                  ) : (
                    '—'
