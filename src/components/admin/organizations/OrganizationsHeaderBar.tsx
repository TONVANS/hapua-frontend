...
interface OrganizationsHeaderBarProps {
  search: string;
...
export function OrganizationsHeaderBar({
  search,
  setSearch,
  loading,
  onRefresh,
  onOpenCreate,
}: OrganizationsHeaderBarProps) {
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-[#002660] tracking-tight">Organizations Master Data</h2>
          <p className="text-xs text-[#4f616f]">ASEAN power utilities, ministry bodies, and observer institutions</p>
        </div>
